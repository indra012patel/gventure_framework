...
;(function ( $, window, document, undefined ) {
		...
		var pluginName = "DateTimePicker1";
		...
		function DateTimePicker1(element, options)
		{
			this.element = element;
			this.settings = $.extend({}, defaults, options);
			this.dataObject = dataObject;
		...
		$.fn.DateTimePicker1 = function (options)
		{
			return this.each(function() 
			{
				if (!$.data(this, "plugin_" + pluginName)) 
				{
					$.data(this, "plugin_" + pluginName, new DateTimePicker1(this, options));
				}
			});
		};
			...
			_addEventHandlersForInput: function()
			{
				...
				var oArrElements = undefined;
 				...
 				if (dtPickerObj.settings.parentElement != undefined)
 				{
					...
					oArrElements = $(dtPickerObj.settings.parentElement).find("[data-field='date'], [data-field='time'], [data-field='datetime'], [data-field='datetime1']");
 				...
 				else
				{
					...
					oArrElements = $("[data-field='date'], [data-field='time'], [data-field='datetime'], [data-field='datetime1']");
				}
