      ...
      if (($this->pages) > 1)
      {
        ...
        if ($this->page != 1) {
          if ($this->showFirstAndLast) {
            $plinks[] = ' <a href="?page=1'.$queryURL.'"><img src="images/first.png" width="32" height="32"></a> ';
          }
          $plinks[] = ' <a href="?page='.($this->page - 1).$queryURL.'"><img src="images/prev.png" width="32" height="32"></a> ';
        }
        ...
        if ($this->page < $this->pages) {
          $slinks[] = ' <a href="?page='.($this->page + 1).$queryURL.'"><img src="images/next.png" width="32" height="32"></a> ';
          if ($this->showFirstAndLast) 
		  {
            $slinks[] = ' <a href="?page='.($this->pages).$queryURL.'"><img src="images/last.png" width="32" height="32"></a> ';
          }
        }
